...
public interface OrdEtcReqService {
    ...
    //1. 주문취소정보 삽입
     boolean insertCancelInfo(OrdEtcReqDto ordEtcReqDto, OrderDetailDto orderDetailDto , OrderDto orderDto, OrderStateDto orderStateDto) throws Exception;
    //     int updateCnt(OrderDetailDto OrderDetailDto) throws Exception;
     boolean insertRefundInfo(OrdEtcReqDto ordEtcReqDto,  OrderDetailDto orderDetailDto , OrderDto orderDto, OrderStateDto orderStateDto, DeliveryDto deliveryDto) throws Exception;
     boolean confirmPurchase(OrderDto orderDto, OrderDetailDto orderDetailDto, OrderStateDto orderStateDto) throws Exception;
     boolean insertExchangeInfo(OrdEtcReqDto ordEtcReqDto, OrderDetailDto orderDetailDto, OrderDto orderDto, OrderStateDto orderStateDto, DeliveryDto deliveryDto) throws Exception;
